...
/* Fallback inline assembly wrappers for BPF helper functions.
 * These inline assembly blocks force a BPF "call" instruction.
 * (Note: This style is architecture–neutral when compiling for BPF; the
 * BPF backend assigns the appropriate registers.)
 */
